...
import Icon from './images/test.jpeg'
            ...
            <div className="main__content container">
                <div className="profile">
                    ...
                    <div className="profile__bio">
                        ...
                        <br/>
                        <p>16歳 高校一年生です<br/>私は日本の駆け出しエンジニアです。現在はブロックチェーン業界とレストランテック業界で働いています。Flutter, Python, React, Firebase, AWSなどを勉強しています。広く浅くでイマイチ深まっていないところもあるので教えていただけるとありがたいです！</p>
                        <br/>
